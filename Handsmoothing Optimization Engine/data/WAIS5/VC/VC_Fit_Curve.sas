...
data pal2 (keep=teid agegrp agedec stdz vctot);
...
%let function=print /*plot save print*/;

%let var=vc /*Variable name without tot*/;
%let moment=mean   /*mean stddev skew kurt*/;
%let grdnorm=1:13/*Theoretical Norming Group range*/;

/*Print and Save Options*/
%let power=3 /*specify only when save and print*/;
